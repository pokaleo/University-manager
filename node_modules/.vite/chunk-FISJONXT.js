...
var ContextMenu = class extends ControllerMixin(ElementMixin(ThemePropertyMixin(ItemsMixin(PolymerElement)))) {
  ...
  ready() {
    super.ready();
    this.addController(new MediaQueryController(this._wideMediaQuery, (matches) => {
      this._wide = matches;
    }));
 ...
 */
//# sourceMappingURL=chunk-FISJONXT.js.map
