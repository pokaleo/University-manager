    ...
    initLazy: (grid) => tryCatchWrapper(function(grid2) {
      ...
      grid2.dataProvider = tryCatchWrapper(function(params, callback) {
        ...
        if (params.parentItem) {
          ...
          grid2.$connector.fetchPage((firstIndex, size) => grid2.$connector.beforeParentRequest(firstIndex, size, params.parentItem.key), page, parentUniqueKey);
        } else {
          ...
          rootRequestDebouncer = Debouncer.debounce(rootRequestDebouncer, timeOut.after(grid2._hasData ? rootRequestDelay : 0), () => {
      ...
      grid2.$connector.set = tryCatchWrapper(function(index, items, parentKey) {
        ...
        for (let i = 0; i < updatedPageCount; i++) {
          ...
          grid2.$connector.doDeselection(slice.filter((item) => !item.selected && (selectedKeys[item.key] || isSelectedOnGrid(item))));
