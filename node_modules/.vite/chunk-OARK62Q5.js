...
var FormLayout = class extends ResizeMixin(ElementMixin(ThemableMixin(PolymerElement))) {
  ...
  updateStyles(properties = {}) {
    console.warn(`WARNING: Since Vaadin 23, updateStyles() is deprecated. Use the native element.style.setProperty API to set custom CSS property values.`);
 ...
 */
//# sourceMappingURL=chunk-OARK62Q5.js.map
