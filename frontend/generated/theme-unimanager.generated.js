...
import stylesCss from 'themes/unimanager/styles.css?inline';
...
export const applyTheme = (target) => {
  ...
  if (!document['_vaadintheme_unimanager_componentCss']) {
    
    document['_vaadintheme_unimanager_componentCss'] = true;
  }
